...
// Module      : --
// Function    : --
// File Name   : CustomRadioButton.cs
// 機能名      : ラジオボタンカスタムコントロール
// Version     : 3.0.0
...
namespace Infocom.Allegro.Web.WebControls
{
	...
	/// </summary>
	/// <remarks>
	/// <b>CustomRadioButton</b> は GRANDIT用に Enter キーによるフォーカス移動、ファンクションキーの割当等をサポートします。
	/// </remarks>
	[
	DefaultProperty("Text"),
	DefaultEvent("CheckedChanged"),
	ToolboxData("<{0}:CustomRadioButton runat=server></{0}:CustomRadioButton>")
	]
	public class CustomRadioButton : System.Web.UI.WebControls.RadioButton, IAllegroContorl
	{
		#region Properties
		/// <summary>
...
// 管理番号K26528 To
			...
			writer.AddAttribute(HtmlTextWriterAttribute.Name, UniqueID.Replace(ID, GroupName));
